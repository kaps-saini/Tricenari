...
class ArticleVerticleAdapter:RecyclerView.Adapter<ArticleVerticleAdapter.HorizontalViewHolder>() {
    ...
    inner class HorizontalViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
        private val articleImage:ImageView = itemView.findViewById(R.id.ivNextArticle)
        private val articleTitle:TextView = itemView.findViewById(R.id.tvArticleTitle)

        fun bind(articleData: ArticleData){
            articleTitle.text = articleData.longTitle
